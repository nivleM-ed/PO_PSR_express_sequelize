...
router.get('/all/submits', purchase_order.get_submits); //show all po submitted for approval
router.get('/all/pending', purchase_order.get_pending); //show all po that is pending for approval
